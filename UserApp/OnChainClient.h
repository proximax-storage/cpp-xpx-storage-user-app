...
class OnChainClient : public QObject
{
    ...
    public:
        void start(const QString& privateKey,
    ...
    signals:
        ...
        void downloadChannelOpenTransactionConfirmed(const QString& channelAlias, const QString& channelId, const QString& driveKey);
        ...
        void downloadFsTreeDirect(const QString& driveId, const QString& fileStructureCdi);
        ...
        void dataModificationApprovalTransactionConfirmed(const std::array<uint8_t, 32>& driveId, const QString& fileStructureCdi);
        void dataModificationApprovalTransactionFailed(const std::array<uint8_t, 32>& driveId, const QString& fileStructureCdi, uint8_t code);
    ...
    private:
        void initConnects();
        void initAccount(const QString& privateKey);
    ...
    private slots:
        void onConnected(xpx_chain_sdk::Config& config, const QString& privateKey);
