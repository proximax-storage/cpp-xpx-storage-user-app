...
{
    const char* m_errorCode = nullptr;
...
{
private:
    std::vector<ErrorCodeDescription> m_dictionary =
    {
        ...
        {"Failure_LockSecret_Invalid_Hash_Algorithm", "Validation failed because the hash algorithm for lock type secret is invalid. See the available algorithms list."},
...
public:
    ...
    const char* translate(const char* errorCode)
    {
